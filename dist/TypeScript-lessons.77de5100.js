...
console.log("Hello"); //How we access the types in TS
...
var together = [4, 'anything', false]; // Functions in TS
...
var sayWords = function sayWords(word) {
  return word;
};

var sayBoth = function sayBoth(word) {
  return "both";
};

var sayWordNum = function sayWordNum(WordNum) {
  return 5;
}; //Optional parametre


var sayOptionalParametre = function sayOptionalParametre(word) {
  return word || 'hello';
}; //You don't need to say the type when you do like this as default parametre


var sayNotype = function sayNotype(word) {
  if (word === void 0) {
    word = 'noTypeHere';
  }
...
var sayRestParams = function sayRestParams(word) {
  if (word === void 0) {
    word = 'noTypeHere';
  }
...
var sayDeclareArr = function sayDeclareArr(word) {
  if (word === void 0) {
    word = 'noTypeHere';
  }
...
sayDeclareArr('string', 3, 5); //explicit means it is clear but implicit is nature thing that you have known already
...
newNames = 'letter';
newNames = 5;
newNames = true; // Union Types with |
...
makeMargin(20);
makeMargin('string');
makeMargin(false); //Good to know 

var makeMargins = function makeMargins(x) {
  return "margin: " + x + "px";
}; //The boolean gives error beacuse it is explicity or unclear


makeMargins(20);
makeMargins('string'); // makeMargins(false); Here is throwing errors
//Type NULL
...
//# sourceMappingURL=/TypeScript-lessons.77de5100.js.map