...
var sayName = function sayName(name, age) {
  console.log(name);
  return name;
};
...
(function (Type) {
  ...
  Type[Type["Quiz"] = 1] = "Quiz";
  Type[Type["BlogPost"] = 2] = "BlogPost";
})(Type || (Type = {}));

var createContent = function createContent(contentType) {};

console.log(Type.Quiz); //String enums

var TypeString;

(function (TypeString) {
  TypeString["Video"] = "VIDEO";
  TypeString["Quiz"] = "QUIZ";
  TypeString["BlogPost"] = "BLOG_POST";
...
},{}]},{},["../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","interface.ts"], null)
